/**********************************************************************************
  Cluster_DFT_VQE.c:
     ...
     Cluster_DFT_VQE.c is a subroutine to perform cluster VQE collinear calculations.

  Log of Cluster_DFT_VQE.c:

  	 Messed up by Yerin Jang
				   ...
				   PyObject *pInst)
{
  ...
  ****************************************************/
  ...
  if (firsttime && memoryusage_fileout){
    PrintMemory("Cluster_DFT_VQE: is1",sizeof(int)*numprocs1,NULL);
    PrintMemory("Cluster_DFT_VQE: ie1",sizeof(int)*numprocs1,NULL);
    PrintMemory("Cluster_DFT_VQE: Num_Snd_EV",sizeof(int)*numprocs1,NULL);
    PrintMemory("Cluster_DFT_VQE: Num_Snd_EV",sizeof(int)*numprocs1,NULL);
    PrintMemory("Cluster_DFT_VQE: index_Snd_i",sizeof(int)*Max_Num_Snd_EV,NULL);
    PrintMemory("Cluster_DFT_VQE: index_Snd_j",sizeof(int)*Max_Num_Snd_EV,NULL);
    PrintMemory("Cluster_DFT_VQE: index_Rcv_i",sizeof(int)*Max_Num_Rcv_EV,NULL);
    PrintMemory("Cluster_DFT_VQE: index_Rcv_j",sizeof(int)*Max_Num_Rcv_EV,NULL);
    PrintMemory("Cluster_DFT_VQE: EVec_Snd",sizeof(double)*Max_Num_Snd_EV,NULL);
    PrintMemory("Cluster_DFT_VQE: EVec_Rcv",sizeof(double)*Max_Num_Rcv_EV,NULL);
  }
  firsttime=0;
  ...
  ***********************************************/
  ...
  if (measure_time){
    printf("Cluster_DFT_VQE myid=%2d time1=%7.3f time2=%7.3f time3=%7.3f time4=%7.3f time5=%7.3f time6=%7.3f time7=%7.3f\n",
